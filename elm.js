...
var author$project$Main$init = {
	board: _List_fromArray(
		[
			_List_fromArray(
			[author$project$Main$NoPlayer, author$project$Main$NoPlayer, author$project$Main$NoPlayer]),
			_List_fromArray(
			[author$project$Main$NoPlayer, author$project$Main$NoPlayer, author$project$Main$NoPlayer]),
			_List_fromArray(
			[author$project$Main$NoPlayer, author$project$Main$NoPlayer, author$project$Main$NoPlayer])
	...
	currentPlayer: author$project$Main$X
};
...
var author$project$Main$listSetAt = F3(
	function (index, newValue, list) {
		return A2(
			elm$core$List$indexedMap,
			F2(
				function (n, current) {
					return _Utils_eq(n, index) ? newValue : current;
				}),
			list);
	});
var author$project$Main$matrixSetAt = F3(
	function (_n0, a, mat) {
		var x = _n0.a;
		var y = _n0.b;
		return A2(
			...
			F2(
				function (i, row) {
					return _Utils_eq(i, x) ? A3(author$project$Main$listSetAt, y, a, row) : row;
				}),
			mat);
	});
var author$project$Main$flipCellInBoard2 = F3(
	function (cell, player, board) {
		return A3(
			author$project$Main$matrixSetAt,
			_Utils_Tuple2(cell.row, cell.col),
			player,
			board);
	});
var author$project$Main$O = {$: 'O'};
var author$project$Main$nextPlayer = function (current) {
	switch (current.$) {
		case 'NoPlayer':
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		return _Utils_update(
			model,
			{
				board: A3(author$project$Main$flipCellInBoard2, cell, model.currentPlayer, model.board),
			...
			_List_fromArray(
				[
					...
					author$project$Main$Flip(
						A2(author$project$Main$Cell, row, col)))
				]),
			_List_fromArray(
				[
					elm$html$Html$text(
...
var author$project$Main$viewRow = F2(
	function (rowIndex, rowData) {
		return A2(
			...
			A2(
				elm$core$List$indexedMap,
				author$project$Main$viewButton(rowIndex),
				rowData));
	});
var author$project$Main$viewBoard = function (board) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		A2(elm$core$List$indexedMap, author$project$Main$viewRow, board));
};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Current player: ' + author$project$Main$playerToString(model.currentPlayer))
					])),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Cell":{"args":[],"type":"{ row : Basics.Int, col : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Flip":["Main.Cell"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));